...
app.get('/:id', http_log.stats);
app.get('/:id/play', passport.middleware, http_log.play);
app.get('/:id/text', passport.middleware, http_log.text);
app.get('/:id/html', passport.middleware, http_log.html);
app.get('/:id/stream', passport.middleware, http_log.stream);
app.get('/:id/download', passport.middleware, http_log.download);
