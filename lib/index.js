...
app.get('/log/:id/play', passport.middleware, http_log.play);
app.get('/log/:id/text', passport.middleware, http_log.text);
app.get('/log/:id/html', passport.middleware, http_log.html);
app.get('/log/:id/stream', passport.middleware, http_log.stream);
app.get('/log/:id/asciicast', passport.middleware, http_log.asciicast);
app.get('/log/:id/download', passport.middleware, http_log.download);
app.put('/log', http_log.create);
