...
app.patch('/api/log/:id', http_log.patch);
app.get('/api/log/:id/stderr', http_log.stderr);
app.get('/api/log/:id/stdout', http_log.stdout);
app.post('/api/log/:id/end', http_log.end);
app.get('/api/log/:id/asciicast', token_ex, passport.required, http_log.asciicast);
